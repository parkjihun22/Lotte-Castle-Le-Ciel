...
<div className={styles.imageContainer}>
            ...
            <div className={styles.mainImageTextSub}>
                ...
                <div className={styles.mainImageTitleBox}>
                  <div className={styles.mainImageText}>평촌이 기다린 새로운 주거 프리미엄</div>
          ...
          <div className={styles.section}>
            <div className={styles.section2}>
              ...
              <img
                src={section2_Image1}
                alt="평촌 롯데캐슬 르씨엘 아파트 조감도-image3"
              />
            </div>
          </div>
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="평촌 롯데캐슬 르씨엘 오시는길안내-image1" />
            </div>
          </div> */}
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 평촌 롯데캐슬 르씨엘에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="평촌 롯데캐슬 르씨엘 모바일 조감도 이미지"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="평촌 롯데캐슬 르씨엘 브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="평촌 롯데캐슬 르씨엘 오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
