...
const BusinessGuide2 = () => {
	...
	return (
		<div className={styles.container}>
			...
			<Helmet>
				{/* 필수 메타 */}
				<title>평촌 롯데캐슬 르씨엘 - 당첨자 서류 안내</title>
				<meta
				name="description"
				content="평촌 롯데캐슬 르씨엘 청약 당첨자를 위한 계약 서류 안내 페이지입니다. 필수 제출 서류와 준비 절차를 확인하고, 빠르고 정확하게 계약을 진행하세요."
				/>
				...
				<meta property="og:title" content="평촌 롯데캐슬 르씨엘 - 당첨자 서류 안내" />
				<meta
            ...
            <h1 className={styles.screenReaderOnly}>평촌 롯데캐슬 르씨엘  - 계약서류안내</h1>
			...
			<img className={`${styles.image4} ${isImageVisible ? styles.visible : ''}`} src={page1} alt="평촌 롯데캐슬 르씨엘 계약서류안내-image1" />
